...
<head>
    ...
    <link rel="stylesheet" href="assets/css/leadForm.css" />
...
<body class="is-boxed has-animations">
                    ...
                    <div class="hero-inner">
                        <div class="hero-copy">
                            ...
                            <p class="hero-cta is-revealing">
                                <a class="button button-primary button-shadow" href="#" data-modal>Pricing and plans</a>
                            </p>
                ...
                <div class="container">
                    <div class="features-inner section-inner">
                        <div class="features-wrap"  >
                            <form class="pricing-table" id="reg_form" name="reg_form" action="api.php" method="post">
                                <div class="pricing-table-inner">
                                    <div class="pricing-table-main">
                                        <div class="pricing-table-header is-revealing">
                                            <div class="pricing-table-price mb-32 pb-24">
                                                <span class="pricing-table-price-amount h2">Send me!</span></div>
                                        </div>
                                    </div>
                                    <div class="form-input-main">
                                        <input class="form-input" type="text" name="first_name" placeholder="Name First"  />
                                    </div>
                                    <div class="form-input-main">
                                        <input class="form-input" type="text" name="last_name" placeholder="Name Second"  />
                                    </div>
                                    <div class="form-input-main">
                                        <input  name="email" placeholder="E-mail" class="form-input"  />
                                    </div>
                                    <div class="form-input-main">
                                        <input name="phone" type="tel" class="form-input" placeholder="Phone"  oninput="this.value = this.value.replace(/\D/g, '')"  />
                                    </div>
                                    <input type="hidden" name="pixel" value="<?php echo $pixel; ?>" />
                                    <input type="hidden" name="subid" value="<?php echo $subid; ?>" />
                                    <input type="hidden" name="phonecc" value="{phonecc}" />
                                    <button type="submit" class="button button-primary button-shadow button-block" onclick="Form.validateForm(event)">Send me!</button>
                                </div>
                            </form>
                        </div>
                    </div>
                            ...
                            <div class="pricing-table">
                                <div class="pricing-table-inner">
                                    ...
                                    <div class="pricing-table-cta is-revealing">
                                        <a class="button button-primary button-shadow button-block" href="#" data-modal>Get early access</a>
                                    </div>
                                </div>
                            </div>
                            <div class="pricing-table">
    ...
    <div class="custom-modal" id="custom-modal" hidden>
        <div class="custom-modal__box">
            <button class="custom-modal__close" id="modal-close">X</button>
            <h3 class="title custom-modal__title">Send me!</h3>
            <form action="api.php" method="post" data-form id="modal">
                <br/>
                <input class="form-input" type="text" name="first_name" id="first_name" placeholder="First Name" data-input-name>
                <br/>
                <input class="form-input" type="text" name="last_name" id="last_name" placeholder="Second Name" data-input-second >
                <br/>
                <input class="form-input" type="email" name="email" id="email" placeholder="Email" data-input-email>
                <br/>
                <input class="form-input" name="phone" id="phone" type="text" placeholder="0501111111" data-input-phone oninput="this.value = this.value.replace(/\D/g, '')">
                <br/>
                <input type="hidden" name="pixel" value="<?php echo $pixel; ?>" />
                <input type="hidden" name="subid" value="<?php echo $subid; ?>" />
                <input type="hidden" name="phonecc" value="{phonecc}" />
                <input type="hidden" name="fmod" value="1" />
                <a id="modal-next" class="button button-primary button-shadow" type="submit" data-modal>Send me!</a>
            </form>
        </div>
    </div>
